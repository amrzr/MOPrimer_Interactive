...
def primer_problem(s, Ct) -> MOProblem:
    ...
    def f_3(fprimer, rprimer):
        ...
        diff_Tm = np.abs(tm_all_f-tm_all_r)
    ...
    def f_4(fprimer, rprimer):
        ...
        return GCclamp + diff_len, 0

    def f_5(fprimer):
        return GC_percent(fprimer), 0


    def f_6(rprimer):
        return GC_percent(rprimer), 0
